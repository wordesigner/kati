...
bingimage_desc = 'برای تولید تصویر از متن از جدیدترین قابلیت‌های هوش مصنوعی استفاده می‌کند و امکان اعمال‌های سبک‌های مختلف هنری را نیز دارد'
...
pikaso_desc = 'قابلیت فوق‌العاده این ابزار تبدیل طرح‌های ساده و اولیه به تصاویر کامل و پیشرفته با کمک هوش مصنوعی است'
...
open_subtitle = ''
open_desc = 'با استفاده از قابلیت‌های هوش مصنوعی ضمن تولید تصویر، پرامپت‌های پیشنهادی نیز ارائه می‌دهد'
open_access = 'رایگان'
...
qriginals_desc = 'این سایت یک سرویس جالب دارد را توسعه داده که به کسب و کارها و فریلنسرها کمک می‌کنند برای سایت‌‌شان با هوش مصنوعی، کیوآر کد بسازند'
...
vidyoai_title = 'ویدیا'
vidyoai_subtitle = ''
vidyoai_desc = 'این ابزار می‌تواند یک ویدیو بلند را به چند ویدیو کوتاه تبدیل کند و به آنها عبارت کلیدی اضافه کند'
