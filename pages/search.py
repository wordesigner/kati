...
katiData = [
    {
        'title': 'چت جی پی تی',
        'subtitle': 'OpenAi',
        'desc': 'چت جی پی تی، امکانی برای چت کردن با هوش مصنوعی است که بر اساس یک مدل زبانی بزرگ ایجاد شده است',
    ...
    },
    {
        'title' : 'کوپایلوت',
        'subtitle' : 'Microsoft',
        'desc' : 'این چت بات به طیف وسیعی از پرسش‌ها و درخواست‌ها جواب مثبت می دهد و روی سیستم‌های اندروید ایجاد و ویندوز قابل دسترس است',
        'access' : 'رایگان و پولی',
    ...
    },
    {
        'title' : 'سونو ای آی',
        'subtitle' : '',
        'desc' : 'یک ابزار جالب برای ساخت آهنگ به زبان‌ها و سبک‌های مختلف در زبان‌های مختلف است',
        'access' : 'رایگان و پولی',
        'link' : 'https://suno.ai',
        'tag' : 'Suno Ai'
    },
    ...
    },
    {
        ...
        'desc' : 'برای تولید تصویر از متن از جدیدترین قابلیت‌های هوش مصنوعی استفاده می‌کند و امکان اعمال‌های سبک‌های مختلف هنری را نیز دارد',
        'access' : 'رایگان و پولی',
    ...
    },
    {
        'title' : 'آیدیوگرام', 
        'subtitle' : '',
        'desc' : 'این ابزار هوش مصنوعی توسط یکی از کارمندان سابق گوگل توسعه داده شده و به خوبی می‌تواند متن‌ها در قالب تصاویر قرار دهد',
        'access' : 'رایگان و پولی',
    ...
    },
    {
        ...
        'desc' : 'این سایت یک سرویس جالب دارد را توسعه داده که به کسب و کارها و فریلنسرها کمک می‌کنند برای سایت‌‌شان با هوش مصنوعی، کیوآر کد بسازند',
        'access' : 'نیمه رایگان',
    ...
    },
    {
        'title' : 'جنمو',
        'subtitle' : '', 
        'desc' : 'این ابزار از تصاویر ثابت ایجاد شده با هوش مصنوعی ویدیوهای متحرک می‌سازد و امکانات مختلفی برای افزودن زاویه‌های دوربین و افکت‌های مختلف دارد',
        'access' : 'رایگان و پولی',
...
def search(search_term):
    ...
    if matched_strings:
        ...
        return html.P(f"هیچ رشته‌ای مطابق با '{search_term}' یافت نشد.")
