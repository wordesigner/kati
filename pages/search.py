...
katiData = [
    ...
    },
    {
        'title' : 'گراک',
        'subtitle' : 'x.ai',
        'desc' : 'با پاسخ‌دهی سریع و با کیفیت بالا، این سرویس هوش مصنوعی به کاربران ایکس (توییتر) امکان می‌دهد متن را به تصویر تبدیل کنند یا تصویر های آپلود شده را تحلیل نمایند',
        'access' : 'پولی',
        'link' : 'https://x.ai/',
        'tag' : 'grok',
    },
    {
        'title' : 'گلیف',
        'subtitle' : 'Spellcasters',
        'desc' : 'این سرویس تقریبا توانایی هر نوع محتوای به محتوای دستکاری شده با هوش مصنوعی را دارد. اگرچه تجربه کاربری گلیف چندان جالب نیست اما قابلیت‌های چشمگیری در ایجاد تصویر، کمیک، طراحی کارکتر، صداسازی و ساخت ویدیو دارد',
        'access' : 'رایگان و پولی',
    ...
    },
    {
        ...
        'desc' : 'این یک موتور جستجو است با این تفاوت که نتایج را برای شما خلاصه می‌کند و در یک قالب کاربر پسند به شما ارائه می‌دهد. اینجا خبری از لینک‌ها نیست، به جستجوی شما پاسخ داده می‌شود',
        'access' : 'رایگان و پولی',
